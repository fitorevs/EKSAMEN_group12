...
export default function MovieCard({name, coverURL, IMDBURL, favedBy, wishedBy}) {
    return (
        <article className="card">
            ...
            {favedBy ? <p>Favoritt til: {favedBy}</p> : null} 
            {wishedBy ? <p>I ønskeliste til: {wishedBy}</p> : null} 
        </article>
    )
}